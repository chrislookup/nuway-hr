  ...
  return (
    <div className="login-wrap">
      <div className="card login-box">
        <img src={`${import.meta.env.BASE_URL}nuway-logo-teal.png`} alt="Nuway Landscape Supplies" style={{ maxWidth: 200, display: 'block', margin: '0 auto 6px' }} onError={e => { e.currentTarget.style.display = 'none' }} onLoad={e => { const h = e.currentTarget.parentElement.querySelector('.login-title'); if (h) h.style.display = 'none' }} />
